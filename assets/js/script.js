...
fetch(`https://api.openweathermap.org/data/2.5/weather?q=${x}&units=imperial&APPID=bad2b3e36cb846608fb20772133c3d58`)
  .then(r => r.json())
  .then(({ main, wind, name, weather, coord}) => {
    ...
    fetch(`https://api.openweathermap.org/data/2.5/uvi?appid=bad2b3e36cb846608fb20772133c3d58&lat=${lat}&lon=${lon}`)
      .then(r => r.json())
      .then(({value}) => {
        let condition
        if ( value <= 2){
  ...
  fetch(`https://api.openweathermap.org/data/2.5/forecast?q=${x}&units=imperial&APPID=bad2b3e36cb846608fb20772133c3d58`)
      .then(r => r.json())
      .then(({list}) =>{
        ...
        document.getElementById('dayOneIcon').innerHTML = (`<img src="https://openweathermap.org/img/wn/${dayOneIcon}.png" alt="Weather Icon">`)
        ...
        document.getElementById('dayTwoIcon').innerHTML = (`<img src="https://openweathermap.org/img/wn/${dayTwoIcon}.png" alt="Weather Icon">`)
        ...
        document.getElementById('dayThreeIcon').innerHTML = (`<img src="https://openweathermap.org/img/wn/${dayThreeIcon}.png" alt="Weather Icon">`)
        ...
        document.getElementById('dayFourIcon').innerHTML = (`<img src="https://openweathermap.org/img/wn/${dayFourIcon}.png" alt="Weather Icon">`)
        ...
        document.getElementById('dayFiveIcon').innerHTML = (`<img src="https://openweathermap.org/img/wn/${dayFiveIcon}.png" alt="Weather Icon">`)
